    ...
    <main className="min-h-screen bg-[#0a0a0a] text-white">
      ...
      <div className="bg-yellow-500/10 border-b border-yellow-500/20 px-4 py-2 text-center">
        <span className="text-xs text-yellow-400">
          ⚠ This is the archived consulting website. <a href="/" className="underline hover:text-yellow-300">View new platform site →</a>
        </span>
      </div>
        ...
        <div className="grid grid-cols-1 md:grid-cols-2 gap-6">
          <div className="relative bg-white/5 border border-green-500/25 rounded-2xl p-6 md:p-8 hover:border-green-500/40 transition">
            ...
            <p className="text-white/60 text-sm leading-relaxed mb-5">
              Record any professional conversation, get automatic transcription, AI-scored communication quality, and instant reports — emailed to supervisors and synced to Google Sheets.
            </p>
            ...
            <a href="https://edgescribe.onrender.com/login" target="_blank" rel="noopener noreferrer"
          ...
          <div className="relative bg-white/5 border border-white/10 rounded-2xl p-6 md:p-8 hover:border-white/20 transition">
            ...
            <p className="text-white/60 text-sm leading-relaxed mb-5">
              Scan a QR code — instantly add any IoT device to your fleet. Supports ESP32, Arduino, nRF52840, STM32, and ARM controllers.
            </p>
            <div className="flex flex-wrap gap-2 mb-6">
    ...
    "edge-conductor": {
            ...
            <div className="space-y-2 mb-4">
              {[
                ...
                <div key={path} className="flex items-center gap-3 bg-black/40 border border-white/10 rounded-lg px-3 py-2">
                  ...
                  <span className="text-xs font-mono text-white/60">{path}</span>
                </div>
              ))}
            </div>
      ...
      <section id="about" className="px-4 md:px-8 py-12 md:py-20 bg-white/5 border-y border-white/10">
        <div className="max-w-4xl mx-auto">
          ...
          <p className="text-white/60 leading-relaxed mb-4">
            ...
            Founded by engineers with 13+ years of hands-on embedded systems experience.
          </p>
        </div>
      </section>
      ...
      <section id="contact" className="px-4 md:px-8 py-12 md:py-20 max-w-2xl mx-auto text-center">
        ...
        <a href="mailto:edgeconductor@gmail.com"
          className="inline-block bg-white text-black px-8 py-4 rounded-full font-medium hover:bg-white/90 transition">
          edgeconductor@gmail.com
        </a>
      </section>

      <footer className="border-t border-white/10 px-4 md:px-8 py-6 text-center text-white/30 text-sm">
        © {new Date().getFullYear()} Edge Conductor — Archived Site
      </footer>
    </main>
  );
}
...
const agenticProjects: {
...
}[] = [
  {
    ...
    desc: "A minimal FastAPI server exposing structured JSON endpoints.",
    tags: ["FastAPI", "Python", "REST API", "JSON Schema"],
    status: "Done",
  },
  {
    category: "MCP · Agentic Infrastructure",
    title: "Agentic Business Profile API",
    desc: "Live API — AI agents query company info, services, projects.",
    tags: ["Next.js", "llms.txt", "Nodemailer", "Vercel"],
    status: "Done",
  },
  {
    category: "AI Chat · LLM Platform",
    title: "Frontier AI — Multi-Model Chat Platform",
    desc: "ChatGPT-style AI chat platform with Google login and model switcher.",
    tags: ["Next.js 15", "Groq", "Supabase", "NextAuth"],
    status: "Done",
  ...
  },
  {
    ...
    desc: "Sensor data → anomaly detection → root cause → maintenance scheduler.",
    tags: ["LangGraph", "MQTT", "ESP32", "Claude API"],
    status: "Planned",
  },
];
